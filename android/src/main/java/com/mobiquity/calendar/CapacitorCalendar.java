...
//    public static final Integer RESULT_CODE_CREATE = 2;
//    public static final String LOG_TAG = "Calendar";
//
//    protected enum KeyIndex {
//        CALENDARS_ID,
...
//               // this. call.reject("Please allow access to the Calendar and try again.");
//                return;
//            }
//        }
//
...
//    public void openCalendar(PluginCall call) {
//        if (!hasRequiredPermissions()) {
//            requestPermissionsCalendar(RESULT_CODE_CREATE);
//        } else {
//            try {
//                JSObject data = call.getData();
//                final Long millis = data.has("date") ? data.getLong("date") : new Date().getTime();
